...
if(this.gen>=6){
var volatilesToCopy=['focusenergy','laserfocus'];for(var _i16=0;_i16<
volatilesToCopy.length;_i16++){var volatile=volatilesToCopy[_i16];
...
case'-clearallboost':{
var timeOffset=this.scene.timeOffset;for(var _i17=0,_this$sides4=
this.sides;_i17<_this$sides4.length;_i17++){var _side4=_this$sides4[_i17];for(var _i18=0,_side4$active=
_side4.active;_i18<_side4$active.length;_i18++){var active=_side4$active[_i18];
if(active){
active.boosts={};
...
case'-cureteam':{
var _poke22=this.getPokemon(args[1]);for(var _i19=0,_poke22$side$pokemon=
_poke22.side.pokemon;_i19<_poke22$side$pokemon.length;_i19++){var _target2=_poke22$side$pokemon[_i19];
_target2.status='';
...
_poke28.addVolatile('formechange',species);for(var _i20=0,_tpoke$moveTrack=
tpoke.moveTrack;_i20<_tpoke$moveTrack.length;_i20++){var _trackedMove=_tpoke$moveTrack[_i20];
...
_poke35.removeTurnstatus('protect');for(var _i21=0,_poke35$side$pokemon=
_poke35.side.pokemon;_i21<_poke35$side$pokemon.length;_i21++){var curTarget=_poke35$side$pokemon[_i21];
...
var foeActive=[];for(var _i22=0,_poke35$side$foe$acti=
_poke35.side.foe.active;_i22<_poke35$side$foe$acti.length;_i22++){var maybeTarget=_poke35$side$foe$acti[_i22];
...
switch(_effect21.id){
case'gravity':
if(!this.fastForward){for(var _i23=0,_this$sides5=
this.sides;_i23<_this$sides5.length;_i23++){var _side7=_this$sides5[_i23];for(var _i24=0,_side7$active=
_side7.active;_i24<_side7$active.length;_i24++){var _active=_side7$active[_i24];
...
for(var _i25=0;_i25<this.p2.pokemon.length;_i25++){
var _pokemon2=this.p2.pokemon[_i25];
...
_pokemon2=this.p2.newPokemon(this.parseDetails(name,pokemonid,details,{item:_pokemon2.item}),_i25);
if(slot>=0)_pokemon2.slot=slot;
return _pokemon2;
}
}
...
if(args[4])_side8.rating=args[4];
