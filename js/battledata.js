...
getPokemonIconNum=function getPokemonIconNum(id,isFemale,facingLeft){
var num=0;
...
var num=this.getPokemonIconNum(id,pokemon&&pokemon.gender==='F',facingLeft);
...
function ModdedDex(modid){this.cache={Moves:{},Items:{},Templates:{}};this.pokeballs=null;this.getAbility=Dex.getAbility;
this.modid=modid;
...
var isMine=window.app&&app.user&&app.user.get('name')===name||
...
var _line23=this.maybeAbility(_effect14,kwArgs.of||_pokemon30);
var _template58=this.template('block',_effect14);
return _line23+_template58.replace('[POKEMON]',this.pokemon(_pokemon30)).replace('[SOURCE]',this.pokemon(attacker||kwArgs.of)).replace('[MOVE]',_move2);
}
