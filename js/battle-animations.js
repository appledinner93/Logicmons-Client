...
var name=pokemon.side&&pokemon.side.n&&(
...
pokemonhtml+="<span class=\"picon has-tooltip\" data-tooltip=\"pokemon|"+side.n+"|"+i+"\" style=\""+Dex.getPokemonIcon(poke,!side.n)+"\" title=\""+_details+"\" aria-label=\""+_details+"\"></span>";
}
...
var ignoreNick=this.siden&&(this.scene.battle.ignoreOpponent||this.scene.battle.ignoreNicks);
